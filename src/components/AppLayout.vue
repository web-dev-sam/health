  ...
  <BaseLayout logo-to="/">
    <template #nav>
      ...
      <div class="hidden sm:flex items-center gap-5 flex-1">
        <RouterLink
          to="/sweeteners"
          class="text-white/40 hover:text-white/80 transition-colors text-xs"
          active-class="text-white"
          >{{ t('nav.sweeteners') }}</RouterLink
        >
        <RouterLink
          to="/preservatives"
          class="text-white/40 hover:text-white/80 transition-colors text-xs"
          active-class="text-white"
          >{{ t('nav.preservatives') }}</RouterLink
        >
        <RouterLink
          to="/emulsifiers"
          class="text-white/40 hover:text-white/80 transition-colors text-xs"
          active-class="text-white"
          >{{ t('nav.emulsifiers') }}</RouterLink
        >
      </div>
